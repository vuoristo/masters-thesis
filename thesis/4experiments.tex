...
\begin{figure}[h!]
    \begin{center}
        ...
        \caption{A simple dataflow diagram created with PREESM. On the left, the Read\_YUV actor acts as a data source for the algorithm represented by the graph. On the right, the display actor acts as the end point of the algorithm, it is called a ``sink'' in the stream processing parlance. The pentagons at the top of the figure are configuration parameters for the model.}
