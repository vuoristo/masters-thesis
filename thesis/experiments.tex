...
\begin{itemize}
    ...
    \item \textbf{Number of Frames Processed Simultaneously} - The OpenEM
        application processes variable number of frames simultaneously.
\end{itemize}
...
\fixme{introduction + explain which block schedule you are talking about} A
block schedule could be generated, which would yield a higher throughput by
